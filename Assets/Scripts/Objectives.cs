...
public class Objectives : MonoBehaviour
{
    ...
    public GameObject plusOneUpgrade;
    public GameObject startLevel2Upgrade;
    public GameObject reviveUpgrade;
    ...
    void Start()
    {
        ...
        {
            plusOneUpgrade.SetActive(true);
        }
        else plusOneUpgrade.SetActive(false);

        if (stats.stayAliveFor10min)
        {
            startLevel2Upgrade.SetActive(true);
        }
        else startLevel2Upgrade.SetActive(false);

        if (stats.allHumansSavedLevel1)
        {
            reviveUpgrade.SetActive(true);
        }
        else reviveUpgrade.SetActive(false);
    ...
    public void CheckIfObjectivesAreCompleted()
    {
        ...
        {
            availebleObjectives[6].completed = true;
        }
        else availebleObjectives[6].completed = false;
